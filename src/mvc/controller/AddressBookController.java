...
public class AddressBookController {
    ...
    private void openAdd(){   
       view.getMainGUIFrame().setVisible(false);
        ...
        choiceListener = new ActionListener() {
            ...
            String facebookid = contactDetailsPanel.getfacebookid().getText();
            System.out.println(facebookid+name);
            flag = validate();
            if(flag)
            {    
             Person person = new Person();
               // String facebookid = null;
             person.setData(name,mobile,email,facebookid);
           ...
           public void actionPerformed(ActionEvent e,String facebookid) {
   ...
   */
    ...
    private void openEdit(){
        ...
        dialog.getPanel().setFacebookid(detailPanel.getfacebookid().getText());
        view.getMainGUIFrame().setVisible(false);
        choiceListener = new ActionListener() {
    ...
    public void loadPersons()       
    {
        ...
        nlp.getJList().addListSelectionListener(new ListSelectionListener()
         ...
         detailPanel.getfacebookid().setEditable(false);
        }
    }  //loadPersons ends
